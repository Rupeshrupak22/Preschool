  ...
  return (
    <div
      className={`flex min-h-14 items-center gap-3 rounded-xl border px-4 font-semibold text-slate-950 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-500 hover:bg-blue-600 hover:text-white ${
        active ? "border-red-500 bg-red-50 ring-1 ring-red-500/25" : "border-slate-200 bg-white"
      }`}
    >
      <span className={`h-3 w-3 rounded-full ${active ? "bg-red-600" : "bg-blue-700"}`} />
      {label}
    </div>
  );
}
...
export default function LMSPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f4f8ff] text-slate-950">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {overviewCards.map((card) => (
              <div key={card.title} className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-blue-500 hover:bg-blue-700 hover:text-white">
                <card.icon className="h-8 w-8 text-red-600 transition group-hover:text-white" />
      ...
      >
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          {examCards.map((card, index) => (
            ...
            >
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-slate-200 bg-white text-red-600 transition group-hover:border-white/25 group-hover:bg-white/15 group-hover:text-white">
      ...
      <section id="demo" className="relative mt-10 bg-gradient-to-br from-red-600 via-blue-950 to-blue-800 px-4 py-16 text-white md:px-6">
