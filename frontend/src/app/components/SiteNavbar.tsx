  ...
  return (
    <nav className="fixed left-0 right-0 top-0 z-[100] border-b border-blue-100 bg-white/98 shadow-[0_8px_28px_rgba(37,99,235,0.08)] backdrop-blur-xl">
      <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between gap-6 px-5 md:px-10">
        ...
        <div className="hidden items-center gap-2 rounded-full border border-blue-100 bg-white px-4 py-2 shadow-[0_10px_35px_rgba(37,99,235,0.12)] lg:flex">
          {navItems.map((item) => (
            <a
              key={item.label}
              href={item.href}
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <a
            href="/login"
            className="inline-flex h-11 items-center justify-center rounded-xl border border-slate-300 bg-white px-5 text-sm font-black text-slate-950 shadow-[0_10px_24px_rgba(15,23,42,0.06)] transition hover:-translate-y-0.5 hover:border-blue-700 hover:bg-blue-700 hover:text-white"
          >
            Login
          </a>
          <a
            href="/signup"
            className="inline-flex h-11 items-center justify-center rounded-xl bg-rose-600 px-5 text-sm font-black text-white shadow-[0_12px_26px_rgba(225,29,72,0.22)] transition hover:-translate-y-0.5 hover:bg-blue-800"
          >
            Sign Up
          </a>
        </div>
        ...
        <button
          className="rounded-xl border border-blue-200 bg-white p-2 text-slate-950 shadow-[0_10px_28px_rgba(37,99,235,0.12)] transition hover:bg-blue-700 hover:text-white lg:hidden"
