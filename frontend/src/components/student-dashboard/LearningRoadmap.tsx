...
const tracks: CourseTrack[] = [
  {
    ...
    icon: Code2,
    steps: [
      { id: "c1", title: "Python Basics", description: "Variables, loops, functions", status: "completed", xp: 200, icon: CheckCircle2, color: "emerald" },
      { id: "c2", title: "Data Structures", description: "Lists, dicts, sets", status: "completed", xp: 250, icon: CheckCircle2, color: "emerald" },
      { id: "c3", title: "OOP Concepts", description: "Classes & objects", status: "completed", xp: 300, icon: CheckCircle2, color: "emerald" },
      { id: "c4", title: "Web with Flask", description: "Build your first web app", status: "active", xp: 350, icon: Zap, color: "blue" },
      { id: "c5", title: "React Basics", description: "Components & state", status: "locked", xp: 400, icon: Lock, color: "slate" },
      { id: "c6", title: "Full Stack Project", description: "Deploy a real app", status: "locked", xp: 500, icon: Lock, color: "slate" },
    ],
  },
  {
    id: "ai",
    ...
    icon: Brain,
    steps: [
      { id: "a1", title: "AI Fundamentals", description: "What is AI & ML", status: "completed", xp: 150, icon: CheckCircle2, color: "emerald" },
      { id: "a2", title: "Data & Statistics", description: "Datasets & analysis", status: "completed", xp: 200, icon: CheckCircle2, color: "emerald" },
      { id: "a3", title: "Supervised Learning", description: "Regression & classification", status: "active", xp: 300, icon: Zap, color: "purple" },
      { id: "a4", title: "Neural Networks", description: "Deep learning basics", status: "locked", xp: 400, icon: Lock, color: "slate" },
      { id: "a5", title: "AI Project", description: "Build an AI model", status: "locked", xp: 500, icon: Lock, color: "slate" },
    ],
  },
  {
    id: "communication",
    ...
    icon: Mic,
    steps: [
      { id: "l1", title: "Public Speaking 101", description: "Confidence & clarity", status: "completed", xp: 150, icon: CheckCircle2, color: "emerald" },
      { id: "l2", title: "Debate Skills", description: "Argument & rebuttal", status: "completed", xp: 200, icon: CheckCircle2, color: "emerald" },
      { id: "l3", title: "Presentation Design", description: "Slides & storytelling", status: "completed", xp: 200, icon: CheckCircle2, color: "emerald" },
      { id: "l4", title: "Team Leadership", description: "Lead & motivate", status: "active", xp: 300, icon: Zap, color: "rose" },
      { id: "l5", title: "TEDx Style Talk", description: "Deliver a 5-min talk", status: "locked", xp: 500, icon: Lock, color: "slate" },
    ],
  },
];
...
const milestones = [
  ...
  { label: "AI Explorer", icon: Brain, earned: true, color: "bg-purple-500" },
